          ...
          <Toolbar>
            ...
            {dataset && (
              <Typography variant="caption" sx={{ mr: 2 }}>
                物品 {dataset.metadata.counts.items} · 配方 {dataset.metadata.counts.recipes} · 单位 {dataset.metadata.counts.units} · 地图 {dataset.metadata.counts.maps} · 地点 {dataset.metadata.counts.locations}
              </Typography>
            )}
