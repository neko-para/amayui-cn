 ...
 *
 * ★当前恒为单位变换：`sub_49CA10`（raw 118402-118512）初始化 `+508` 为单位阵，而本作语料
 * 只用 `0x344` 建节点（`0x346`-`0x34D` 全代码 0 次）⇒ `Scene+46532`（"有节点矩阵"位，
 * raw 134385）恒 0 ⇒ 引擎在 `sub_4B0360` 里**根本不乘** `Scene+46536`。
 */
