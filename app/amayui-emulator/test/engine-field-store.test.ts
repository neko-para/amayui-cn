...
test('0x78 / 0x8B / 0x1A4 / 0x252 / 0x261 / 0x2EE / 0x2DB / 0x24E / 0x10F：写入对应字段', async () => {
  const cases: [number, number[], number, number][] = [
    ...
    //   引擎 raw 33584-33586 `_this[122464] = op1`；★消费端**已落地**（`armCoexistAutoMessage` + `#autoMessageInterval`，`tickets/T-0151` 落 + `tickets/T-0161` 加"生产读者棘轮"）；仍未建模的是**第二个计算点** raw 20416-20426（被 `Engine[122501]` 门控、「行数 − 基准」**不减 1**）⇒ 见 `tickets/T-0161` / `T-0175`。
