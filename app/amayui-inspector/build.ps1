# 构建 amayui-inspector（Core 库 + CLI 冒烟 + WPF 壳）。目标框架 net10.0（SDK 10 离线可用）。
...
Write-Host ''
Write-Host '== build WPF App (M2 shell) =='
dotnet build "$root\AmayuiInspector.App\AmayuiInspector.App.csproj" -c Debug -v minimal
