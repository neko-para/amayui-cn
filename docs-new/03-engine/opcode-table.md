...
| 0x238 | 1 |  | sub_4248C0 | 已核对 | **画布尺寸对**：`Engine[92338] = 0`、`Engine[92339] = op1`（字节 369352/369356；全工程的其它引用只有复位清零）。handler=sub_4248C0（raw 32303-32312）。语料 **2056 处 / 343 个脚本**。emulator：**建模** —— `OPS` 的 `op_set_canvas_size` 写 `engineValues`。 |
