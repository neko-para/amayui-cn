...
│   ├── stub-reaudit-2026-09.md ← **已 stub 指令的复评台账**：57 条 stub 逐条判据（42 要实现 / 14 排除（视频·Live2D·键盘输入）/ 1 真·空）+ 批次进度（**A1/A2/A3/A4/A6 已完成**：34 条转真实现，`ENGINE_INTERNAL_OPS` 48 → 23；A6 = AGERC 接口解锁存档/读档界面）+ **§4 逐条状态总表（由代码实算）**
