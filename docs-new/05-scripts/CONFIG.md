...
| `150-172` | `i300 9 1 3e8` | 全局文本样式（i075 1e=30px / i076·i077 颜色 / i2bd 1 加粗 / i197 a 注音 10px / **i08b 10 = 行间距 16 ⇒ 换行步进 30+16 = 46px**（引擎 Font+1380；tickets/T-0038）/ i261 1 竖排标志）+ 打开窗 9 的贴出闸门并设 1000ms 停留 |
