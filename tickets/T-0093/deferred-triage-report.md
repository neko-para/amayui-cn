...
按「两种写法都数」重算后总数 = **292**，与 `handoff-2026-09.md:27` 的 292 一致 ⇒ 口径确认。
...
2. **`handoff-2026-09.md` 内部计数不一致**：§1 表格写 "deferred 28"、§5 写 "`deferred` **27 条 = 292 处**"；`analysis/opcode-gaps.json` 实际是 **28 条 = 292 处**（我算的 292 与之吻合）。建议 owner 顺手统一（这是文档卫生，不是新发现）。
